...
class MainViewModel(private val repository: GifRepository) : ViewModel() {
    ...
    val isErrorDisplaying: LiveData<Boolean> get() = _isErrorDisplaying
    ...
    fun getNewGif() {
        ...
        viewModelScope.launch {
            try {
                ...
                if (isErrorDisplaying.value == null || isErrorDisplaying.value == false) _isErrorDisplaying.value = true
                _isLoading.value = false
            }
        }
    }
